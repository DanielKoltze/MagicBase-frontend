...
createCollectionBtn.addEventListener('click', async e => {
    ...
    const descriptionInput = document.getElementById("createCollectionDescriptionInput").value
    const formatTypeInput = document.getElementById("createCollectionTypeInput").value
